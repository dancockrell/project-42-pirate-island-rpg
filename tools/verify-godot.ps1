...
$checks = @(
    ...
    @{ Script = "res://tests/island_bridge_test.gd"; Completion = "PASS: actual Rust island bridge, scenario document, solo start, movement, ocean rejection, pause, arrival and the campaign clock" }
)
