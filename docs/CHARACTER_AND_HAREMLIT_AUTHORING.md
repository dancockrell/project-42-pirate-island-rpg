...
## Required Record for Michael and Every Heroine

Before a character enters production, her character source must point to an
authored profile that supplies all of the following.
...
6. **Group relationships.** At least two specific relationships with other
   ...
   scene.
7. **Adventure expression.** A signature weapon, seven direct D-through-SSS
   skills, readable animation actions, exploration contribution and a visible
   reason to bring her along.
...
His visual language is 1850s American frontier filtered through a wrecked
...
No new heroine may be marked production-ready until this record, her seven
skills, complete animation action boards, identity sheet, title-card behavior,
and household interactions have been authored and reviewed together.
